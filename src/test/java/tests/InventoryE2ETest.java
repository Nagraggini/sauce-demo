...
public class InventoryE2ETest extends BaseTest {
        ...
        void checkPricesOnThreePages() {
                 ...
                 * 
                 * double firstItemPriceOnIntentoryPage =
                 * inventoryPage.getPriceofAnItem(firstItemName);
                 * double secondItemPriceOnIntentoryPage =
                 * inventoryPage.getPriceofAnItem(secondItemName);
                 * 
                 ...
                 * "A " + firstItemName +
                 * " ára nem egyezik meg az Inventory és a Cart oldalon.");
                 * 
                 ...
                 * 
                 * // A checkoutStepTwoPage-n lévő árak lekérhetőek a cartPage-n lévő
                 * metódussal.
                 * double firstItemPriceCheckoutStepTwoPage =
                 * cartPage.getPriceOfAnItem(firstItemName);
                 * double secondItemPriceCheckoutStepTwoPage =
                 * cartPage.getPriceOfAnItem(secondItemName);
                 * 
                 ...
                 * 
                 * assertEquals((firstItemPriceOnIntentoryPage +
                 * secondItemPriceOnIntentoryPage),
                 * summarySubtotal,
